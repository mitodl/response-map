...
if (array_key_exists('submit', $_POST) && $_POST['submit'] === 'Save' && !empty($_POST['user_location'])) {
...
<form action="response.php" method="post" accept-charset="utf-8">
    ...
    <div class="input-group">
        ...
        <input type="text" class="form-control user-fullname" name="user_fullname"
               value="<?php echo isset($_POST['user_fullname']) ? $_POST['user_fullname'] : '' ?>">
    </div>
    <div class="input-group">
        ...
        <input type="text" class="form-control user-location" name="user_location"
               value="<?php echo isset($_POST['user_location']) ? $_POST['user_location'] : '' ?>">
    </div>
    <div class="input-group">
        <span class="input-group-addon"><?php echo $response_label; ?></span>
        <textarea class="form-control user-response" rows="5"
    ...
    <div class="upload-group" style="<?php echo $upload_style ?>">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <img
                    id="image-preview" <?php echo isset($_POST['user_thumbnail_url']) ? 'src="' . $_POST['user_thumbnail_url'] . '""' : '' ?>>
            </div>
        </div>
    </div>

    <input type="hidden" id="image-url" name="user_image_url"
           value="<?php echo isset($_POST['user_image_url']) ? $_POST['user_image_url'] : '' ?>">
    <input type="hidden" id="thumbnail-url" name="user_thumbnail_url"
           value="<?php echo isset($_POST['user_thumbnail_url']) ? $_POST['user_thumbnail_url'] : '' ?>">
