...
if (empty($_SESSION['authenticated'])) {
    echo 'Error: You do not have permission to visit this page. The MIT Response Map Tool is not loading, which may be caused by your web browser blocking third party cookies. Please enable third party cookies via your browser preferences or add mitx-edx-lti-response-map.herokuapp.com to the whitelist. (<a href"https://support.bigcommerce.com/articles/Public/How-do-I-allow-third-party-cookies-to-be-set-in-my-browser" target="_blank">How do I do this?</a>)';
    die();
}
